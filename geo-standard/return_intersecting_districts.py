...
def main():
    parser = argparse.ArgumentParser(
        description='Find intersecting districts for a given parcel.')
    parser.add_argument(
        'short_code', help='Short code representing the base directory.')
    parser.add_argument('--coords', nargs='+', type=float,
                        help='Coordinates of the parcel. Should be in the format --coords x1 y1 x2 y2 x3 y3 ...')
    parser.add_argument('--file', type=str,
                        help='GIS file representing the parcel.')
