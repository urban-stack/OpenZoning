...
##It will find any districts that intersect with the parcel and write the results to a JSON file named intersecting_districts.json.
...
def main():
    ...
    if args.coords:
        ...
        parcel = gpd.read_file(args.file)
    else:
    ...
    # Write the resulting list of tuples to a JSON file
    with open('intersecting_districts.json', 'w') as outfile:
