...
**The Open Zoning Feed Specification (OZFS)** is a first-of-its-kind national data language -- or, schema -- for zoning codes, allowing zoning codes to be machine-readable.  
